      ...
      <v-flex xs10 offset-xs1 md4 offset-md4 class="my-3">
        <v-card class="py-5">
          <v-layout column wrap align-center justify-center class="mx-4">
              ...
              <v-btn color="primary" :loading="loading" @click.native="loader = 'loading'" :disabled="loading">Sign in</v-btn>
              <v-btn color="primary" flat :to="{name: 'Register'}">Register</v-btn>
          </v-layout>
        </v-card>
      </v-flex>
    </section>
